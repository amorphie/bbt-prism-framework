...
public static class ServiceCollectionCommonExtensions
{
    ...
    public static IServiceProvider BuildServiceProviderFromFactory<TContainerBuilder>(this IServiceCollection services, Action<TContainerBuilder>? builderAction = null) where TContainerBuilder : notnull
    {
        ...
        {
            throw new PrismException($"Could not find {typeof(IServiceProviderFactory<TContainerBuilder>).FullName} in {services}.");
        }
    ...
    /// </summary>
    static internal T? GetService<T>(this IServiceCollection services)
    {
        return services
            .GetSingletonInstance<IPrismApplication>()
            .ServiceProvider
            .GetService<T>();
    }
    ...
    /// This method should be used only after dependency injection registration phase completed.
    /// </summary>
    static internal object? GetService(this IServiceCollection services, Type type)
    {
        return services
            .GetSingletonInstance<IPrismApplication>()
            .ServiceProvider
