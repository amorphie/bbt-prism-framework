...
public class PrismAutoMapperOptions
{
    public List<Action<IPrismAutoMapperConfigurationContext>> Configurators { get; } = new();

    public ITypeList<Profile> ValidatingProfiles { get; set; } = new TypeList<Profile>();
