...
{
    protected AbstractKeyReadOnlyAppService(IServiceProvider serviceProvider, IReadOnlyRepository<TEntity> repository)
    ...
    where TEntity : class, IEntity
{
    ...
    protected AbstractKeyReadOnlyAppService(
